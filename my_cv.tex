...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Mohammed}{Shahid}{ \urlstyle{same}\href{http://shahid.xyz}{shahid.xyz}\\
\href{mailto:helovetocode@protonmail.com}{helovetocode@protonmail.com} \\
\href{address:}{Ovalley,Gudalur,The Nilgiris, TN}
}
...
\subsection{Anna University}
\descript{B.Tech Inforamtion Technology}
\location{2016-2020 | Coimbatore, TN}
Info Institute Of Engineering \\
% \location{ Cum. GPA: 3.83 / 4.0 \\
% Major GPA: 3.9 / 4.0}
\sectionsep

\subsection{GTMO HR.SEC SCHOOL}
\location{12. May 2016|  Gudalur, TN}
% \subsection{NHHS}
% \location{10. May 2014|  Gudalur, TN}
\sectionsep
...
Gitlab:// \href{https://gitlab.com/He_Love_To_Code}{\bf shahid} \\
...
Go \textbullet{} Dart \textbullet{} Julia \textbullet{} R \textbullet{} \LaTeX\ \\ 
% \location{Over 1000 lines:}
\subsection{Markup Languages}
HTML \textbullet{} CSS \textbullet{} \\
\location{Familiar:}
Linux \textbullet{} \textbullet{} Android \textbullet{} MySQL
\sectionsep
